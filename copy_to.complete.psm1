$CopyToPythonCommand = "copy-to.exe"
$CopyToCommandAlias = "copy-to"

Function copy-to {
    Invoke-Expression "$CopyToPythonCommand $args"
}

$CopyToArgCompleteScriptBlock = {
    ...
    Invoke-Expression $CopyToPythonCommand -OutVariable completionResult -ErrorVariable errorOut -ErrorAction SilentlyContinue | Out-Null
...
Register-ArgumentCompleter -Native -CommandName $CopyToCommandAlias -ScriptBlock $CopyToArgCompleteScriptBlock

# Export
Export-ModuleMember -Function copy-to
